...
The next insight that we found is shown in \@ref(fig:insight2). This plot examines how national happiness relate to different levels of climate change awareness. The plot reveals that countries with citizens who have less awareness tend to have lower happiness. And in contrast, a higher level of awareness indicates a higher level of happiness, which shows a positive correlation.
...
This insight is supported by the summary statistics in table \@ref(tab:insight2)
