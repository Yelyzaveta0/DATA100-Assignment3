...
```{r figure1, fig.cap="Parallel trends in the arctic loss and the average happiness score from 2013-2019, showing potential environmental impacts on global wellbeing."}
...
summary_table <- combined_data |>
  ...
  summarise(
    ...
    avg_awareness = mean(climate_awareness_index, na.rm = TRUE),
    correlation_ice_happiness = cor(ice_loss, happiness_score, use = "complete.obs"),
    n_countries = n_distinct(country),
    .groups = "drop"
  ) |>
  mutate(across(where(is.numeric), round, 3))

kable(summary_table, caption = "Summary statistics by geographic region (2015-2023)")
```
